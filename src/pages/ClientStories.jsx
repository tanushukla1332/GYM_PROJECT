...
export default function ClientStories() {
  const clients=[
    ...
    },
    {
        ...
        name: "Shweta Mehta",
        description: "Winner of Indian Show, Roadies (Season 15), Shweta is a software engineer but today is a successful bikini athlete and fitness enthusiast and is extremely popular in her online community for her bodyweight trainings. ",
    },
    {
    ...
    },
    {
        ...
        description: "Yasmin is a certified Pilates trainer and instructor. She also owns the Yasmin’s Body Image. Started more than two decades back it was one-of-its-kind fitness class with emphasis on aerobics and palates. "
    },
    {
        image:"https://www.grynow.in/assets/blog/top-indian-fitness-influencers/banji.webp",
        name: "Bani J.",
        description: "Her real name is Bani J. She is a muscular woman – covered her entire body with tattoos. She shares her workout sessions and the way to build a body to die for. She also shares her healthy diet and follows a strict gym training;"
    },
    {
