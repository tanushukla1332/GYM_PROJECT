    ...
    <div className={contact.First_div}>
      ...
      <section className={contact.container}>
          <div className={contact.leftContainer}>
            <img src="https://media.istockphoto.com/id/1202561276/photo/contact-us-concept-wood-block-symbol-telephone-mail-and-address-on-desk.jpg?s=612x612&w=0&k=20&c=4h7TrXOZjd-unR6L2b8DjPq1_u_bsXxbMDzVTIa7drA=" alt="" height="100vh"/>
          </div>
